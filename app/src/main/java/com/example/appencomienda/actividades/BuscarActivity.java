...
public class BuscarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaView = (ListView) findViewById(R.id.busc_listView);
        thiscontext= this;
        this.dni = findViewById(R.id.busc_dni);
        findViewById(R.id.busc_btn_busc).setOnClickListener(View -> buscar());
        findViewById(R.id.buscVolver).setOnClickListener(View -> volver());
    }
