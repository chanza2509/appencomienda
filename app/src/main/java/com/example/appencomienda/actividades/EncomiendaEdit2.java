...
public class EncomiendaEdit2 extends AppCompatActivity {
    Spinner spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_encomienda_edit2);

        this.id = (getIntent().getExtras()).getInt("id");
        findViewById(R.id.editVolver2).setOnClickListener(View -> volver());
        findViewById(R.id.edit_btn_Editar2).setOnClickListener(View -> editar());


        //Vamos a setear los tviewer
        this.dni = findViewById(R.id.editDni2);
        this.nombres = findViewById(R.id.editNombres2);
        this.apellidos = findViewById(R.id.editApellidos2);
        this.precio = findViewById(R.id.editPrecio2);
        this.encomiendaTv = findViewById(R.id.editEncomienda2);
        this.destino = findViewById(R.id.edit2Destino);


        Toast.makeText(getBaseContext(), id + " ", Toast.LENGTH_SHORT).show();
        spinner = findViewById(R.id.tvspinnerEstado2);
    ...
    public void volver( ){
        Intent i = new Intent(this, BuscarAdmiActitvity.class);
        startActivity(i);
    }
